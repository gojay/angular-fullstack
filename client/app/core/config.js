(() => {
	...
	angular.module('app.core')
		.constant('CONFIG', {
			...
			cities: ['Aceh', 'Bali', 'Banten', 'Bengkulu', 'Gorontalo' , 'Jakarta' , 'Jambi', 'Jawa Barat', 'Jawa Tengah' , 'Jawa Timur', 'Kalimantan Barat' , 'Kalimantan Selatan' , 'Kalimantan Tengah' , 'Kalimantan Tengah', 'Kalimantan Timur' , 'Kalimantan Utara','Kepulauan Bangka', 'Kepulauan Riau' , 'Lampung', 'Maluku', 'Maluku Utara', 'Nusa Tenggara Barat', 'Nusa Tenggara Timur', 'Sumatera Selatan', 'Sumatera Barat', 'Sumatera Utara', 'Yogyakarta'  ]
		})
